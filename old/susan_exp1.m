function [ output_args ] = susan_exp1( obj,hobj )
%comment here
...
%% looping
firstframe_intensity=0;
current_intensity=0;
iloop=0;
while current_intensity>=0.1*firstframe_intensity || iloop == 0 %run while temporary image is
    iloop = iloop +1 ;
    ...
    expRates=[20,5,95];
    frameRates=[40,100,10];
    txt={'25ms Imgs Running','25ms Imgs Running','25ms Imgs Running'};
    ...
    expRate = expRates(ii); %exposure rate
    frameRate = frameRates(ii); %frames per second acquisition
