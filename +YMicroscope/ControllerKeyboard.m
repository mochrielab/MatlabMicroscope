classdef ControllerKeyboard < YMicroscope.Controller
...
%         capture_state = 0 % don't need this
%         togglelight_state = 0 % don't need this
%         togglelightselection_state = 0 % don't need this
        zoomin_state=0;
        zoomout_state=0;
    end
    
    methods
        function obj =  ControllerKeyboard()
            % 
