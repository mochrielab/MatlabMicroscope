classdef UIViewControllerRecord < YMicroscope.UIView
    ...
    methods
        function obj = UIViewControllerRecord(microscope_handle)
            import YMicroscope.*
...
%                         disp('move down') --> back
            ...
            obj.actions=[MicroscopeActionLive(...
                ...
                obj.microscope_handle,obj.imageaxis_handle,obj.hist_handle),...
                MicroscopeActionLiveRecord(...
                obj.microscope_handle,obj.imageaxis_handle,obj.hist_handle),...
                MicroscopeActionLiveFNetRecord(...
                obj.microscope_handle,obj.imageaxis_handle,obj.hist_handle),...
                ];
%             obj.savingFilename = TiffIO(obj.microscope_handle.datapath,'headername');
            ...
            obj.addControlSelector(1,3,'lockfocus','LiveFocus',...
                obj.actions(4));
            obj.addControlSelector(1,4,'lockfocus','LiveFocusRecord',...
                obj.actions(6));
            ...
            obj.addParamCell(2,1,'clockrate','Sampling Rate of Clock (Hz)',...
                obj.microscope_handle.trigger);
            % setting live rate for record purpose
            obj.addParamCell(2,2,'rate','Live Rate of Clock (Hz)',...
                obj.actions(5).eventloop);
            obj.addParamCell(2,3,'rate','Live Rate of FNet Clock (Hz)',...
                obj.actions(6).eventloop);
            obj.addParamCell(3,0,'focalplanecorrect','Focal Plane Correction (pixel)',...
                obj.actions(4));
            obj.addParamCell(3,1,'focalplanecorrect','Record Focal Plane Correction (pixel)',...
                obj.actions(6));
            obj.addParamCell(3,2,'headername','Filename',...
                obj.microscope_handle);
